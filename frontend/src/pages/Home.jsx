          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-center lg:text-left">
              ...
              <div className="animate-fade-in-up delay-300 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-2">
                <Link
                  to="/shop"
                  className="btn-glow inline-flex items-center justify-center px-7 py-4 text-base font-bold text-white bg-brand-600 hover:bg-brand-700 rounded-xl shadow-lg hover:shadow-xl transition-all gap-2 hover:-translate-y-0.5"
                >
                  Explore Shop
