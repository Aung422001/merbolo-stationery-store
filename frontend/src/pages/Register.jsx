    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-white p-8 rounded-3xl border border-brand-100 shadow-sm space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-slate-900 font-serif">Create Your Account</h1>
          <p className="text-xs text-slate-500">Join MerboloEbook for a faster checkout experience.</p>
        </div>
